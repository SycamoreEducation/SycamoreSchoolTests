module.exports = {
    ...
    'School News Archive Test': (client) => {
        ...
        client.page.frontDesk.familyDirectory()
            ...
            .assert.attributeEquals('@studentSearchBtn', 'value', 
                'Student Search')
