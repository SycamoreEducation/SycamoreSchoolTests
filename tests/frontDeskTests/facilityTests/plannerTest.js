...
module.exports = {
    ...
    'Facility Planner Test': (client) => {
        ...
        client.page.frontDesk.facility()
            ...
            .assert.containsText('@breadcrumb', 'Utilities/Facility Mgr/ Planner')
            ...
            .assert.attributeEquals('@backDayBtn', 'href', `${page.url()}/facilityplanner.php?selectdate=${moment().subtract(1, 'days').format('MM/DD/YYYY')}`)

            .assert.visible('@forwardDayBtn')
            .assert.containsText('@forwardDayBtn', moment().add(1, 'days').format('MMMM DD, YYYY'))
            .assert.attributeEquals('@forwardDayBtn', 'href', `${page.url()}/facilityplanner.php?selectdate=${moment().add(1, 'days').format('MM/DD/YYYY')}`)
