module.exports = {
    tags: ['addressBookTests', 'addressBookAdditionalFieldsTests', 
        'additionalFieldsCompanyTest'],

    'Additional Fields Company Test': (client) => {
        ...
        client.page.addressBook.additionalFields.additionalFields()
            .waitForElementVisible('@companyTab', 5000)
            .click('@companyTab')
            ...
            .assert.attributeEquals('@newFieldBtn', 'onclick', 'addstat(2)')
