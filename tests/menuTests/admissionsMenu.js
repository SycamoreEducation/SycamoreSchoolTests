module.exports = {
    ...
    'Admissions Menu Test': (client) => {
        ...
        client.page.menu()
            ...
            .assert.attributeEquals('@admissions', 'href', page.url() + 
                '/schoolmenu.php#')
            ...
            .assert.attributeEquals('@inquiries', 'href', page.url() + 
                '/schoolmenu.php#')
            
            .assert.visible('@enrollment')
            .assert.containsText('@enrollment', '\273 Enrollment')
            .assert.attributeEquals('@enrollment', 'href', page.url() + 
                '/schoolmenu.php#')
            
            .assert.visible('@classMgr')
            .assert.containsText('@classMgr', '\273 Class Mgr')
            .assert.attributeEquals('@classMgr', 'href', page.url() + 
                '/schoolmenu.php#')
            
            .assert.visible('@courseMgr')
            .assert.containsText('@courseMgr', '\273 Course Mgr')
            .assert.attributeEquals('@courseMgr', 'href', page.url() + 
                '/schoolmenu.php#')

            .assert.visible('@admissionsCommunication')
            .assert.containsText('@admissionsCommunication', 
                '\273 Communication')
            .assert.attributeEquals('@admissionsCommunication', 'href', 
                page.url() + '/schoolmenu.php#')
            
            .assert.visible('@portalMgr')
            .assert.containsText('@portalMgr', '\273 Portal Mgr')
            .assert.attributeEquals('@portalMgr', 'href', page.url() + 
                '/schoolmenu.php#')
            
            .assert.visible('@admissionsConfiguration')
            .assert.containsText('@admissionsConfiguration', 
                '\273 Configuration')
            .assert.attributeEquals('@admissionsConfiguration', 'href',
                page.url() + '/schoolmenu.php#')
            
            .assert.visible('@admissionsReports')
            .assert.containsText('@admissionsReports', 'Reports')
            .assert.attributeEquals('@admissionsReports', 'href', page.url() + 
                '/reports.php?type=18')

            .click('@inquiries')
            .assert.visible('@inquiresStudents')
            .assert.containsText('@inquiresStudents', 'Students')
            .assert.attributeEquals('@inquiresStudents', 'href', page.url() + 
                '/enrollstudentprospects.php')
            
            .assert.visible('@inquiriesFamilies')
            .assert.containsText('@inquiriesFamilies', 'Families')
            .assert.attributeEquals('@inquiriesFamilies', 'href', page.url() + 
                '/enrollfamilyprospects.php')
            ...
            .assert.attributeEquals('@enrollmentStudent', 'href', page.url() + 
                '/enrollstudents.php')
            
            .assert.visible('@enrollmentFamilies')
            .assert.containsText('@enrollmentFamilies', 'Families')
            .assert.attributeEquals('@enrollmentFamilies', 'href', page.url() + 
                '/enrollfamilies.php')
            ...
            .assert.attributeEquals('@classMgrClasses', 'href', page.url() + 
                '/enrollclasses.php')
            ...
            .assert.containsText('@admissionsCommunicationBatchEmail', 
                'Batch Email')
            .assert.attributeEquals('@admissionsCommunicationBatchEmail', 
                'href', page.url() + '/batchemail3.php?classid=-2')

            .click('@portalMgr')
            .assert.visible('@portalMgrStudents')
            .assert.containsText('@portalMgrStudents', 'Students')
            .assert.attributeEquals('@portalMgrStudents', 'href', page.url() + 
                '/enrollstudents2.php')
            
            .assert.visible('@portalMgrFamilies')
            .assert.containsText('@portalMgrFamilies', 'Families')
            .assert.attributeEquals('@portalMgrFamilies', 'href', page.url() + 
                '/enrollfamilies2.php')
            
            .assert.visible('@portalMgrApplications')
            .assert.containsText('@portalMgrApplications', 'Applications')
            .assert.attributeEquals('@portalMgrApplications', 'href', page.url()
                + '/enrollapplications.php')
            
            .assert.visible('@portalMgrEssayQuestions')
            .assert.containsText('@portalMgrEssayQuestions', 'Essay Questions')
            .assert.attributeEquals('@portalMgrEssayQuestions', 'href', 
                page.url() + '/enrollessays.php')
            
            .assert.visible('@portalMgrRequestedDocs')
            .assert.containsText('@portalMgrRequestedDocs', 'Requested Docs')
            .assert.attributeEquals('@portalMgrRequestedDocs', 'href', 
                page.url() + '/essentialdocuments.php')
            ...
            .assert.containsText('@admissionsConfigurationChecklist', 
                'Checklist')
            .assert.attributeEquals('@admissionsConfigurationChecklist', 'href',
                page.url() + '/enrollcheck.php')
            
            .assert.visible('@admissionsConfigurationDocuments')
            .assert.containsText('@admissionsConfigurationDocuments', 
                'Documents')
            .assert.attributeEquals('@admissionsConfigurationDocuments', 'href',
                page.url() + '/enrolldocs.php')
            
            .assert.visible('@admissionsConfigurationAgreements')
            .assert.containsText('@admissionsConfigurationAgreements', 
                'Agreements')
            .assert.attributeEquals('@admissionsConfigurationAgreements', 
                'href', page.url() + '/enrollagreements.php')
            
            .assert.visible('@admissionsConfigurationTuitionPlans')
            .assert.containsText('@admissionsConfigurationTuitionPlans', 
                'Tuition Plans')
            .assert.attributeEquals('@admissionsConfigurationTuitionPlans', 
                'href', page.url() + '/tuition.php')
            
            .assert.visible('@admissionsConfigurationEnrollStatus')
            .assert.containsText('@admissionsConfigurationEnrollStatus', 
                'Enroll Status')
            .assert.attributeEquals('@admissionsConfigurationEnrollStatus', 
                'href', page.url() + '/enrollstatus.php')
            
            .assert.visible('@admissionsConfigurationSetup')
            .assert.containsText('@admissionsConfigurationSetup', 'Setup')
            .assert.attributeEquals('@admissionsConfigurationSetup', 'href', 
                page.url() + '/enrollconfig.php')
