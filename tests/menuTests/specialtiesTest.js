module.exports = {
    ...
    'Specialties Menu Test': (client) => {
        ...
        client.page.menu()
            ...
            .assert.attributeEquals('@nursesOffice', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@ptConferences', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@discipline', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@serviceMgr', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@connectionMgr', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@tranportationMgr', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@volunteerMgr', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@libraryMgr', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@auctionMgr', 'href', 'http://web/schoolmenu.php#')
            ...
            .assert.attributeEquals('@athleticDirectorSports', 'href', 'http://web/adsports.php')
            .assert.attributeEquals('@athleticDirectorTeams', 'href', 'http://web/adteams.php')
            .assert.attributeEquals('@athleticDirectorScoreboard', 'href', 'http://web/adscoreboard.php')
            .assert.attributeEquals('@athleticDirectorEquipment', 'href', 'http://web/eqinventory.php')
            ...
            .assert.attributeEquals('@nursesOfficeDailyLogs', 'href', 'http://web/medicallogs.php')
            .assert.attributeEquals('@nursesOfficeStudents', 'href', 'http://web/medicalstudents.php')
            .assert.attributeEquals('@nursesOfficeReports', 'href', 'http://web/reports.php?type=19')
            ...
            .assert.attributeEquals('@nursesOfficeConfigurationComplaints', 'href', 'http://web/medicalcomplaints.php')
            .assert.attributeEquals('@nursesOfficeConfigurationMedications', 'href', 'http://web/medicalmedications.php')
            .assert.attributeEquals('@nursesOfficeConfigurationImmunizations', 'href', 'http://web/medicalshots.php')
            ...
            .assert.attributeEquals('@disciplineStudents', 'href', 'http://web/discipline.php')
            .assert.attributeEquals('@disciplineDailyLogs', 'href', 'http://web/disciplinelogs.php')
            .assert.attributeEquals('@disciplineDetentions', 'href', 'http://web/disciplinedetentions.php')
            .assert.attributeEquals('@disciplineConfiguration', 'href', 'http://web/disciplineviolations.php')
            .assert.attributeEquals('@disciplineReports', 'href', 'http://web/reports.php?type=20')
            ...
            .assert.attributeEquals('@serviceMgrStudents', 'href', 'http://web/service.php?task=liststudents')
            .assert.attributeEquals('@serviceMgrFamilies', 'href', 'http://web/service.php?task=listfamilies')
            .assert.attributeEquals('@serviceMgrDailyLogs', 'href', 'http://web/servicelogs.php')
            .assert.attributeEquals('@serviceMgrOpportunites', 'href', 'http://web/serviceops.php')
            .assert.attributeEquals('@serviceMgrReports', 'href', 'http://web/reports.php?type=23')
            ...
            .assert.attributeEquals('@connectionMgrStudents', 'href', 'http://web/connect.php?task=liststudents')
            .assert.attributeEquals('@connectionMgrDailyLogs', 'href', 'http://web/connectlogs.php')
            .assert.attributeEquals('@connectionMgrInitiator', 'href', 'http://web/connectroles.php')
            .assert.attributeEquals('@connectionMgrReports', 'href', 'http://web/reports.php?type=28')
            ...
            .assert.attributeEquals('@tranportationMgrBusRoutes', 'href', 'http://web/tm_busroute.php')
            .assert.attributeEquals('@tranportationMgrFieldTrips', 'href', 'http://web/tm_fieldtrip.php')
            .assert.attributeEquals('@tranportationMgrCarpoolMgr', 'href', 'http://web/tm_carpool.php')
            .assert.attributeEquals('@tranportationMgrParkingPasses', 'href', 'http://web/tm_parkingpass.php')
            .assert.attributeEquals('@tranportationMgrReports', 'href', 'http://web/reports.php?type=33')
            ...
            .assert.attributeEquals('@volunteerMgrEvents', 'href', 'http://web/volunteer.php?view=1')
            ...
            .assert.attributeEquals('@libraryMgrBook', 'href', 'http://web/library.php?task=book')
            .assert.attributeEquals('@libraryMgrStudents', 'href', 'http://web/librarystudents.php')
            .assert.attributeEquals('@libraryMgrCheckIn', 'href', 'http://web/librarydesk.php?task=checkin')
            .assert.attributeEquals('@libraryMgrCheckOut', 'href', 'http://web/librarydesk.php?task=checkout')
            .assert.attributeEquals('@libraryMgrWhatsOut', 'href', 'http://web/librarydesk.php?task=whatsout&grade=99')
            .assert.attributeEquals('@libraryMgrBooks', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@libraryMgrSearch', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@libraryMgrConfiguration', 'href', 'http://web/schoolmenu.php#')
            .assert.attributeEquals('@libraryMgrReports', 'href', 'http://web/reports.php?type=30')
            ...
            .assert.attributeEquals('@libraryMgrBooksLibrary', 'href', 'http://web/librarybooks.php')
            .assert.attributeEquals('@libraryMgrBooksTextBooks', 'href', 'http://web/libraryclassbooks.php')
            .assert.attributeEquals('@libraryMgrBooksInventoryLibrary', 'href', 'http://web/libraryinventory.php')
            ...
            .assert.attributeEquals('@libraryMgrSearchLocal', 'href', 'http://web/library.php?action=search')
            .assert.attributeEquals('@libraryMgrSearchGoogle', 'href', 'http://web/librarysearch.php')
            ...
            .assert.attributeEquals('@libraryMgrConfigurationLocations', 'href', 'http://web/librarylocations.php')
            .assert.attributeEquals('@libraryMgrConfigurationImport', 'href', 'http://web/librarybookimport.php')
            .assert.attributeEquals('@libraryMgrConfigurationSetup', 'href', 'http://web/libraryconfig.php')
            ...
            .assert.attributeEquals('@auctionMgrStaff', 'href', 'http://web/auction_staff.php')
            .assert.attributeEquals('@auctionMgrAuctions', 'href', 'http://web/auctions.php')
            .assert.attributeEquals('@auctionMgrAuctionItems', 'href', 'http://web/auctionitems.php')
            .assert.attributeEquals('@auctionMgrDonorCompanies', 'href', 'http://web/auctiondonors.php')
            .assert.attributeEquals('@auctionMgrReports', 'href', 'http://web/reports.php?type=21')
