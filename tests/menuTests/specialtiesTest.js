module.exports = {
    ...
    'Specialties Menu Test': (client) => {
        ...
        client.page.menu()
            ...
            .assert.attributeEquals('@specialties', 'href', page.url() + '/schoolmenu.php#')
            ...
            .assert.attributeEquals('@nursesOfficeDailyLogs', 'href', page.url() + '/medicallogs.php')
            
            .assert.visible('@nursesOfficeStudents')
            .assert.containsText('@nursesOfficeStudents', 'Students')
            .assert.attributeEquals('@nursesOfficeStudents', 'href', page.url() + '/medicalstudents.php')
            ...
            .assert.attributeEquals('@nursesOfficeReports', 'href', page.url() + '/reports.php?type=19')
            ...
            .assert.attributeEquals('@nursesOfficeConfigurationComplaints', 'href', page.url() + '/medicalcomplaints.php')
            
            .assert.visible('@nursesOfficeConfigurationMedications')
            .assert.containsText('@nursesOfficeConfigurationMedications', 'Medications')
            .assert.attributeEquals('@nursesOfficeConfigurationMedications', 'href', page.url() + '/medicalmedications.php')
            ...
            .assert.attributeEquals('@nursesOfficeConfigurationImmunizations', 'href', page.url() + '/medicalshots.php')
            ...
            .assert.attributeEquals('@ptConferencesTeachers', 'href', page.url() + '/ptconf_teachers.php')
            
            .assert.visible('@ptConferencesByDate')
            .assert.containsText('@ptConferencesByDate', 'by Date')
            .assert.attributeEquals('@ptConferencesByDate', 'href', page.url() + '/ptconf_admin.php?view=date')
            
            .assert.visible('@ptConferencesByTeacher')
            .assert.containsText('@ptConferencesByTeacher', 'by Teacher')
            .assert.attributeEquals('@ptConferencesByTeacher', 'href', page.url() + '/ptconf_admin.php?view=staff')
            
            .assert.visible('@ptConferencesConfiguration')
            .assert.containsText('@ptConferencesConfiguration', 'Configuration')
            .assert.attributeEquals('@ptConferencesConfiguration', 'href', page.url() + '/ptconf_admin.php?view=config')
            ...
            .assert.attributeEquals('@disciplineStudents', 'href', page.url() + '/discipline.php')
            
            .assert.visible('@disciplineDailyLogs')
            .assert.containsText('@disciplineDailyLogs', 'Daily Logs')
            .assert.attributeEquals('@disciplineDailyLogs', 'href', page.url() + '/disciplinelogs.php')
            
            .assert.visible('@disciplineDetentions')
            .assert.containsText('@disciplineDetentions', 'Detentions')
            .assert.attributeEquals('@disciplineDetentions', 'href', page.url() + '/disciplinedetentions.php')
            
            .assert.visible('@disciplineConfiguration')
            .assert.containsText('@disciplineConfiguration', 'Configuration')
            .assert.attributeEquals('@disciplineConfiguration', 'href', page.url() + '/disciplineviolations.php')
            
            .assert.visible('@disciplineReports')
            .assert.containsText('@disciplineReports', 'Reports')
            .assert.attributeEquals('@disciplineReports', 'href', page.url() + '/reports.php?type=20')
            ...
            .assert.attributeEquals('@serviceMgrStudents', 'href', page.url() + '/service.php?task=liststudents')
            
            .assert.visible('@serviceMgrFamilies')
            .assert.containsText('@serviceMgrFamilies', 'Families')
            .assert.attributeEquals('@serviceMgrFamilies', 'href', page.url() + '/service.php?task=listfamilies')
            
            .assert.visible('@serviceMgrDailyLogs')
            .assert.containsText('@serviceMgrDailyLogs', 'Daily Logs')
            .assert.attributeEquals('@serviceMgrDailyLogs', 'href', page.url() + '/servicelogs.php')
            
            .assert.visible('@serviceMgrOpportunites')
            .assert.containsText('@serviceMgrOpportunites', 'Opportunities')
            .assert.attributeEquals('@serviceMgrOpportunites', 'href', page.url() + '/serviceops.php')
            
            .assert.visible('@serviceMgrReports')
            .assert.containsText('@serviceMgrReports', 'Reports')
            .assert.attributeEquals('@serviceMgrReports', 'href', page.url() + '/reports.php?type=23')
            ...
            .assert.attributeEquals('@connectionMgrStudents', 'href', page.url() + '/connect.php?task=liststudents')
            
            .assert.visible('@connectionMgrDailyLogs')
            .assert.containsText('@connectionMgrDailyLogs', 'Daily Logs')
            .assert.attributeEquals('@connectionMgrDailyLogs', 'href', page.url() + '/connectlogs.php')
            
            .assert.visible('@connectionMgrInitiator')
            .assert.containsText('@connectionMgrInitiator', 'Initiator')
            .assert.attributeEquals('@connectionMgrInitiator', 'href', page.url() + '/connectroles.php')
            
            .assert.visible('@connectionMgrReports')
            .assert.containsText('@connectionMgrReports', 'Reports')
            .assert.attributeEquals('@connectionMgrReports', 'href', page.url() + '/reports.php?type=28')
            ...
            .assert.attributeEquals('@tranportationMgrBusRoutes', 'href', page.url() + '/tm_busroute.php')
            
            .assert.visible('@tranportationMgrFieldTrips')
            .assert.containsText('@tranportationMgrFieldTrips', 'Field Trips')
            .assert.attributeEquals('@tranportationMgrFieldTrips', 'href', page.url() + '/tm_fieldtrip.php')
            
            .assert.visible('@tranportationMgrCarpoolMgr')
            .assert.containsText('@tranportationMgrCarpoolMgr', 'Carpool Mgr')
            .assert.attributeEquals('@tranportationMgrCarpoolMgr', 'href', page.url() + '/tm_carpool.php')
            
            .assert.visible('@tranportationMgrParkingPasses')
            .assert.containsText('@tranportationMgrParkingPasses', 'Parking Passes')
            .assert.attributeEquals('@tranportationMgrParkingPasses', 'href', page.url() + '/tm_parkingpass.php')
            
            .assert.visible('@tranportationMgrReports')
            .assert.containsText('@tranportationMgrReports', 'Reports')
            .assert.attributeEquals('@tranportationMgrReports', 'href', page.url() + '/reports.php?type=33')
            ...
            .assert.attributeEquals('@libraryMgrSearchLocal', 'href', page.url() + '/library.php?action=search')
            
            .assert.visible('@libraryMgrSearchGoogle')
            .assert.containsText('@libraryMgrSearchGoogle', 'Google')
            .assert.attributeEquals('@libraryMgrSearchGoogle', 'href', page.url() + '/librarysearch.php')
            ...
            .assert.attributeEquals('@libraryMgrConfigurationLocations', 'href', page.url() + '/librarylocations.php')
            
            .assert.visible('@libraryMgrConfigurationImport')
            .assert.containsText('@libraryMgrConfigurationImport', 'Import')
            .assert.attributeEquals('@libraryMgrConfigurationImport', 'href', page.url() + '/librarybookimport.php')
            
            .assert.visible('@libraryMgrConfigurationSetup')
            .assert.containsText('@libraryMgrConfigurationSetup', 'Setup')
            .assert.attributeEquals('@libraryMgrConfigurationSetup', 'href', page.url() + '/libraryconfig.php')
            ...
            .assert.attributeEquals('@auctionMgrStaff', 'href', page.url() + '/auction_staff.php')
            
            .assert.visible('@auctionMgrAuctions')
            .assert.containsText('@auctionMgrAuctions', 'Auctions')
            .assert.attributeEquals('@auctionMgrAuctions', 'href', page.url() + '/auctions.php')
            
            .assert.visible('@auctionMgrAuctionItems')
            .assert.containsText('@auctionMgrAuctionItems', 'Items')
            .assert.attributeEquals('@auctionMgrAuctionItems', 'href', page.url() + '/auctionitems.php')
            
            .assert.visible('@auctionMgrDonorCompanies')
            .assert.containsText('@auctionMgrDonorCompanies', 'Donor Companies')
            .assert.attributeEquals('@auctionMgrDonorCompanies', 'href', page.url() + '/auctiondonors.php')
            
            .assert.visible('@auctionMgrReports')
            .assert.containsText('@auctionMgrReports', 'Reports')
            .assert.attributeEquals('@auctionMgrReports', 'href', page.url() + '/reports.php?type=21')
