module.exports = {
    ...
    'Utilities Menu Test': (client) => {
        ...
        client.page.menu()
            ...
            .assert.attributeEquals('@utilities', 'href', page.url() + 
                '/schoolmenu.php#')
            ...
            .assert.attributeEquals('@eventMgrManagedEvents', 'href', page.url()
                 + '/eventproperty.php?task=list')
            
            .assert.visible('@eventMgrRegistration')
            .assert.containsText('@eventMgrRegistration', 'Registration')
            .assert.attributeEquals('@eventMgrRegistration', 'href', page.url()
                 + '/eventregistrations.php')
            
            .assert.visible('@eventMgrParticipants')
            .assert.containsText('@eventMgrParticipants', 'Participants')
            .assert.attributeEquals('@eventMgrParticipants', 'href', page.url()
                 + '/eventparticipants.php')
            
            .assert.visible('@eventMgrReports')
            .assert.containsText('@eventMgrReports', 'Reports')
            .assert.attributeEquals('@eventMgrReports', 'href', page.url() + 
                '/reports.php?type=24')
            ...
            .assert.attributeEquals('@workflowMgrByStatus', 'href', page.url() +
                 '/ticket.php?task=bystatus')
            
            .assert.visible('@workflowMgrByAuthor')
            .assert.containsText('@workflowMgrByAuthor', 'by Author')
            .assert.attributeEquals('@workflowMgrByAuthor', 'href', page.url() +
                 '/ticket.php?task=byauthor')
            
            .assert.visible('@workflowMgrByCategory')
            .assert.containsText('@workflowMgrByCategory', 'by Category')
            .assert.attributeEquals('@workflowMgrByCategory', 'href', page.url()
                 + '/ticket.php?task=bycatagory')
            
            .assert.visible('@workflowMgrByClassroom')
            .assert.containsText('@workflowMgrByClassroom', 'by Classroom')
            .assert.attributeEquals('@workflowMgrByClassroom', 'href', 
                page.url() + '/ticket.php?task=byproject')
            
            .assert.visible('@workflowMgrCategories')
            .assert.containsText('@workflowMgrCategories', 'Categories')
            .assert.attributeEquals('@workflowMgrCategories', 'href', page.url()
                 + '/ticketcatagories.php')
            ...
            .assert.attributeEquals('@databaseMgrPublicTables', 'href', 
                page.url() + '/databases.php?task=list&type=1')
            
            .assert.visible('@databaseMgrPrivateTables')
            .assert.containsText('@databaseMgrPrivateTables', 'Private Tables')
            .assert.attributeEquals('@databaseMgrPrivateTables', 'href', 
                page.url() + '/databases.php?task=list&type=2')
            ...
            .assert.attributeEquals('@onlineFormMgrActive', 'href', page.url() +
                 '/forms.php?task=list&type=active')
            
            .assert.visible('@onlineFormMgrNonActive')
            .assert.containsText('@onlineFormMgrNonActive', 'Non Active')
            .assert.attributeEquals('@onlineFormMgrNonActive', 'href', 
                page.url() + '/forms.php?task=list&type=nonactive')
            ...
            .assert.attributeEquals('@knowledgeBasePublished', 'href', 
                page.url() + '/knowledge.php?task=list')
            
            .assert.visible('@knowledgeBasePending')
            .assert.containsText('@knowledgeBasePending', 'Pending')
            .assert.attributeEquals('@knowledgeBasePending', 'href', page.url() 
                + '/knowledge.php?task=pending')
