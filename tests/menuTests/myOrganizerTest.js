module.exports = {
    ...
    'My Organizer Menu Test': (client) => {
        ...
        client.page.menu()
            ...
            .assert.attributeEquals('@myOrganizer', 'href', page.url() + 
                '/schoolmenu.php#')
