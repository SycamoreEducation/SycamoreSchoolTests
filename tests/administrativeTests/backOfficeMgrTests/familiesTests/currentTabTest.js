module.exports = {
    tags: ['administrativeTests', 'backOfficeMgrTests', 
        'backOfficeFamiliesTests', 'backOfficeFamiliesCurrentTabTest'],

    'Back Office Families Current Test': (client) => {
        ...
        client.page.menu()
            ...
            .click('@backOfficeMgrFamiliesCurrent');
        client.frame(null);

        client.frame(2);
        client.page.administrative.backOfficeMgr.families.currentTab()
            ...
            .assert.visible('@actionSelect')
            .assert.containsText('@actionSelect', 'Choose Action')

            .assert.visible('@goBtn')
            .assert.attributeEquals('@goBtn', 'value', 'Go')
            .assert.attributeEquals('@goBtn', 'onclick', 'ProcessGo()')
            ...
            .assert.containsText('@familyCount', 'Count: 1')
