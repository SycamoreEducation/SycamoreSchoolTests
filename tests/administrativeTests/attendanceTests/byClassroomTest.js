...
module.exports = {
    tags: ['administrativeTests', 'attendanceTests', 'attendanceByClassTest'],
    ...
    'Attendance Homeroom Test': (client) => {
        ...
        client.page.menu()
            ...
            .click('@attendanceByClassroom')
        client.frame(null);

        client.frame(2);
        client.page.administrative.attendance.byClassroom()
            .waitForElementVisible('@breadcrumb', 5000)
            .assert.visible('@breadcrumb')
            .assert.containsText('@breadcrumb', 
                'Administrative/Attendance/ By Classrooms')
            ...
            .assert.attributeEquals('@backMonthBtn', 'href', page.url() + 
                `/attendclasses.php?year=${moment().format('YYYY')}&` + 
            ...
            .assert.containsText('@typeSelect', 'Day Long')
            .assert.attributeEquals('@typeSelect', 'onchange', 'newType()')
